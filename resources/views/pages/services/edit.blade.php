                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{route('services.update', $jenisLayanan)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama Layanan</label>
                                            <input type="text" class="form-control" id="nama_layanan" name="nama_layanan" value="{{ $jenisLayanan->nama_layanan }}"
                                                placeholder="Isi Nama Layanan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="intial_name">Inisial</label>
                                            <input type="text" class="form-control" id="initial_name" name="initial_name" value="{{ $jenisLayanan->intial_name }}"
